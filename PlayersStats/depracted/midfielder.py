...
def generate_midfielder_stats():
    ...
    # Configuration for Midfielder stats
    stat_config = {
        'Mental': {
        ...
        'Playmaking': {
            ...
            'Passing': {'mean': 65, 'std_dev': 4},
            'Crossing': {'mean': 65, 'std_dev': 4},
        },
        'Athletic': {
...
def get_midfielder_stats():
    stats = generate_midfielder_stats()
