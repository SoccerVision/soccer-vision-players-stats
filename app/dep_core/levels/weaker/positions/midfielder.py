...
class Midfielder(WeakerPlayer):
    ...
    def get_stat_config(self):
        ...
        stat_config['Playmaking']['Creative'] = {'mean': 55, 'std_dev': 4}
        stat_config['Playmaking']['Passing'] = {'mean': 57, 'std_dev': 4}
        stat_config['Playmaking']['Crossing'] = {'mean': 55, 'std_dev': 4}

        stat_config['Attack']['Finishing'] = {'mean': 35, 'std_dev': 4}
        stat_config['Attack']['Long Shots'] = {'mean': 45, 'std_dev': 4}
        stat_config['Attack']['Off The Ball'] = {'mean': 40, 'std_dev': 4}
