...
import random
from app.core.levels.weaker.positions.defender import Defender
from app.core.levels.weaker.positions.midfielder import Midfielder
from app.core.levels.weaker.positions.striker import Striker
from app.core.levels.weaker.positions.fullback import FullBack
from app.core.levels.weaker.positions.winger import Winger
from app.core.levels.weaker.positions.goalkeeper import Goalkeeper

def generate_weaker_team():
    team = []
